...
public class AddressBookController {
    ...
    public R<AddressBook> getDefault() {
        ...
        if (0 == count) {
            ...
            wrapper.orderByDesc(AddressBook::getUpdateTime).last("limit 1");
            AddressBook temporaryAddress = addressBookService.getOne(wrapper);
            return R.success(temporaryAddress);
        } else {
            return R.success(addressBook);
        }
    }
